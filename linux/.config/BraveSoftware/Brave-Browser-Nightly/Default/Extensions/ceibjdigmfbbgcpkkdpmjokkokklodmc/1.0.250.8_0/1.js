...
l=l=>{
	...
	let n='('+JSON.stringify(e)+')';a&&a();
	if(L._st||typeof l.C != 'object'){
		let C={}, g=3, s=(i,x)=>{
			if(i>1)C.C=x.replace(/\t\/\/[^\n]+\n/g,'').replace(/\t/g,'').replace(/\n/g,'').replace(/'\+ '/g,'').replace(/\}if/g,'};if'),j(C.C+n);
			...
			if(!--g)st1.textContent=e.m?C.I:C.i, st2.textContent=e.m?C.S:C.s, e.C=C, sync(e), j('st.t()')
		};
		r(e.l+'2.js',x=>s(2,x));r(e.l+'css',x=>s(1,x));r(e.l+'mcss',x=>s(0,x))
	}else st1.textContent=e.m?l.C.I:l.C.i, st2.textContent=e.m?l.C.S:l.C.s, j(l.C.C+n)
},
db={
