...
(function (WebStoreURL) {
    WebStoreURL["Chrome"] = "https://chrome.google.com/webstore/detail/dhccaifficimfjcpbapjockkipmmlkab?hl=ru";
    WebStoreURL["ChromeDev"] = "https://chrome.google.com/webstore/detail/dhccaifficimfjcpbapjockkipmmlkab?hl=ru";
    WebStoreURL["Firefox"] = "https://addons.mozilla.org/ru/firefox/addon/lostfilm-tv-\u043E\u0444\u0438\u0446\u0438\u0430\u043B\u044C\u043D\u044B\u0439-\u043F\u043B\u0430\u0433\u0438\u043D/";
...
(function (HeaderNames) {
    HeaderNames["AddonData"] = "LF-BB-WebExt";
    HeaderNames["AddonProxyValidity"] = "LF-BB-Addon-Proxy";
    HeaderNames["AddonSiteId"] = "LF-X-BB-ID";
...
exports.config = {
    ...
    redirectorURL: chrome.runtime.getURL(types_1.Page.Redirector),
    settingsVersion: 2,
    supportPageUrl: `https://${config_domain_1.mainDomain}/addon/`,
    useDevDomain: config_domain_1.useDevDomain,
    warnIfMissingPermissions: false,
};
exports.refLinks = {
    optionsVpn: `https://${config_domain_1.mainDomain}/`,
    popupVpn: `https://${config_domain_1.mainDomain}/`,
};
...
Object.defineProperty(exports, "__esModule", { value: true });
const AbstractModule_1 = __webpack_require__(4);
const utils_1 = __webpack_require__(0);
...
exports.sld = exports.useDevDomain ? 'torrents' : 'www.lostfilm';
exports.tld = exports.useDevDomain ? 'loc' : 'tv';
exports.proxies = exports.useDevDomain ? ['HTTPS proxy71.torrents.loc:443'] : ['SOCKS5 185.85.121.12:1080'];
exports.mainDomain = 'www.lostfilm.tv';
...
const common_1 = __webpack_require__(3);
const config_1 = __webpack_require__(5);
const ErrorHandler_1 = __webpack_require__(21);
const instances_1 = __webpack_require__(7);
const Messaging_1 = __webpack_require__(22);
const OptionsPage_1 = __webpack_require__(23);
const Permissions_1 = __webpack_require__(24);
const PopupPage_1 = __webpack_require__(25);
const ProxyAuto_1 = __webpack_require__(26);
const ProxyController_1 = __webpack_require__(28);
const ProxyOnRequest_1 = __webpack_require__(29);
const ProxyPAC_1 = __webpack_require__(30);
const ProxyScript_1 = __webpack_require__(31);
const RedirectorPage_1 = __webpack_require__(32);
const Settings_1 = __webpack_require__(33);
const SolutionPage_1 = __webpack_require__(34);
const types_1 = __webpack_require__(2);
const utils_1 = __webpack_require__(0);
const WebRequest_1 = __webpack_require__(35);
...
const AbstractModule_1 = __webpack_require__(4);
const common_1 = __webpack_require__(3);
const decorators_1 = __webpack_require__(27);
const utils_1 = __webpack_require__(0);
